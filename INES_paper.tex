...
an unconditional text generation model is a language modeling problem.
...
We also randomly drop out individual fields with probability 10\%, and drop out all but the article body with probability 35\%\cite{NIPS2019_9106}.
...
The purpose of our model was to generate not articles but comments likely to be written by SNS users.
